    ...
    <div class="d-flex flex-column">
      <div class="d-flex flex-row">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="{{ $product->name }}" aria-label="nome1"
            aria-describedby="basic-addon1" disabled>
        </div>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">Preço, R$:</span>
          <input type="text" class="form-control" placeholder="{{ $product->price_cents }}"
            aria-label="preco1" aria-describedby="basic-addon1" disabled>
        </div>
      </div>
      <div class="d-flex flex-row">
        <div class="d-flex w-75 input-group mb-3">
          ...
          <textarea class="form-control" placeholder="{{ $product->description }}"
            aria-label="With textarea" disabled></textarea>
        </div>
      ...
      <div class="d-flex flex-row">
        ...
        <div class="d-flex w-50 border rounded ms-auto">
